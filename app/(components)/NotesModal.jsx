...
export default function NotesModal({ date, week, year, onClose }) {
      ...
      <div className="bg-white w-full max-w-md rounded-xl shadow-2xl p-5 animate-fadeIn border border-green-200">
        ...
        <div className="flex justify-evenly items-center mb-8">
          ...
          <button onClick={onClose}>
            <X className="w-3 h-3 sm:w-5 sm:h-5 text-green-600 bg-green-100 hover:bg-green-300 border rounded-xl" />
          </button>
        </div>
            ...
            notes.map((n) => (
              ...
              >
                <div className="flex-1">
                  <p className="text-sm text-gray-800 leading-snug capitalize">
                    {n.text}
                  </p>
